...
- `.claude/docs/pages/*` — per-page documentation. `dashboard.md`, `my-items.md`, `quickadd.md`, `insights.md`, `catalog-analysis.md`, `feature-flags.md`, `user-hub.md`, `admin-hub.md`, `storage.md`, `storage-detail.md`, `shopping-lists.md`, `waste.md`, `spending.md`, `spending-history.md`, `health-score.md`, `reminders.md`, `settings.md`, `meals.md`, `meals-form.md`, `catalog.md`, `catalog-entry.md`, `purchase-event-detail.md`, `foodbanks.md`, `about.md`.
