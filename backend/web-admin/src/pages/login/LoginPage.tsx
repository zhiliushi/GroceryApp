        ...
        <div className="bg-ga-bg-card border border-ga-border rounded-xl p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              title="Sign in with the email + password you set when you created the account."
            ...
            <div className="text-center">
              <button
                ...
                disabled={loading}
                title="Type your email above first, then tap here. Firebase emails you a one-time reset link."
          ...
          <button
            ...
            disabled={loading}
            title="Sign in with your Google account. No password to remember; no verification email needed."
